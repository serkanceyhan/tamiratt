            ...
            [
                ...
                'services' => [
                    ...
                    [
                        ...
                        'master_content' => '<h2>{location} Ofis Koltuğu Kumaş Değişimi</h2><p>Koltuklarınızın süngeri sağlam ama kumaşı mı lekelendi?</p><ul><li><strong>Hijyen:</strong> Eski kumaşlardan kurtulun.</li><li><strong>Kurumsal Kimlik:</strong> Dekorasyona uygun renk.</li><li><strong>Ekonomi:</strong> %70 tasarruf.</li></ul>'
                    ],
                    [
