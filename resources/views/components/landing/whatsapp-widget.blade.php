...
<div x-data="{ 
    ...
    <button @click="open = !open"
            class="relative w-16 h-16 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full shadow-2xl transition-all transform hover:scale-110 flex items-center justify-center group">
        {{-- Pulse Animation --}}
        <div class="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-75"></div>
