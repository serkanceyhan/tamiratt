<x-landing-layout>
    <x-slot:head>
        ...
        <meta name="description" content="Tamiratt pazaryerine hizmet veren olarak katılın.">
    </x-slot:head>
            ...
            <div class="max-w-[1280px] mx-auto px-6">
                <div class="max-w-3xl mx-auto text-center">
                    ...
                    <h1 class="text-4xl lg:text-5xl font-black text-gray-900 dark:text-white mb-6 leading-tight">
                        Pazaryerimize <span class="text-primary">Katılın</span>
                    </h1>
                    <p class="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                        Ofis mobilyası tamir alanında uzmanıysanız, binlerce iş fırsatına erişin. 
        ...
        <section class="py-16 bg-gray-50 dark:bg-background-dark">
            <div class="max-w-[1280px] mx-auto px-6">
                <div class="max-w-3xl mx-auto">
                    ...
                    <form action="{{ route('provider.apply.store') }}" method="POST" enctype="multipart/form-data" class="space-y-10">
                        @csrf
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="name" value="{{ old('name') }}" required
                                        class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-primary transition-all @error('name') border-red-500 @enderror"
                                ...
                                <div>
                                    ...
                                    <input type="tel" name="phone" value="{{ old('phone') }}" required 
                                        class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-primary transition-all @error('phone') border-red-500 @enderror"
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="email" name="email" value="{{ old('email') }}" required
                                        class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-primary transition-all @error('email') border-red-500 @enderror"
                        ...
                        <div class="bg-white dark:bg-surface-dark rounded-2xl shadow-lg p-8">
                            <div class="flex items-center gap-4 mb-6">
                                ...
                                <h2 class="text-xl font-bold text-gray-900 dark:text-white">Firma Bilgileri</h2>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Firma / Ticari Unvan *</label>
                                    <input type="text" name="company_name" value="{{ old('company_name') }}" required
                                        class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-primary transition-all @error('company_name') border-red-500 @enderror"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="tax_number" value="{{ old('tax_number') }}"
                                        class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-primary transition-all"
                        ...
                        <div class="bg-white dark:bg-surface-dark rounded-2xl shadow-lg p-8">
                            <div class="flex items-center gap-4 mb-6">
                                ...
                                <div>
                                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Uzmanlık Alanları *</h2>
                                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Hangi hizmetlerde uzmanlaştığınızı seçin</p>
                                </div>
                            </div>
                            @if($services->count() > 0)
                            ...
                            @else
                                <div class="text-center py-8 text-gray-500">
                                    ...
                                    <p>Henüz hizmet kategorisi tanımlanmamış.</p>
                                </div>
                            @endif
                        ...
                        <div class="bg-white dark:bg-surface-dark rounded-2xl shadow-lg p-8">
                            <div class="flex items-center gap-4 mb-6">
                                ...
                                <div>
                                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Hizmet Bölgeleri *</h2>
                                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Hangi illerde hizmet verebilirsiniz?</p>
                                </div>
                            </div>
                            @if($cities->count() > 0)
                        ...
                        <div class="bg-white dark:bg-surface-dark rounded-2xl shadow-lg p-8">
                            <div class="flex items-center gap-4 mb-6">
                                ...
                                <div>
                                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Belgeler *</h2>
                                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Vergi levhası, kimlik veya ustalık belgesi (PDF, JPG, PNG - Max 5MB)</p>
                                </div>
                            </div>
                            <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-8 text-center hover:border-primary transition-colors bg-gray-50 dark:bg-gray-800/50">
                                ...
                                <label for="documents-input" class="cursor-pointer block">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-400 mb-1">Dosyaları sürükleyin veya</p>
                                    <span class="text-primary font-semibold hover:underline">buraya tıklayın</span>
                                </label>
            ...
            <div class="max-w-[1280px] mx-auto px-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="text-center p-6">
                        ...
                        <h3 class="font-bold text-lg text-gray-900 dark:text-white mb-2">Hızlı Onay</h3>
                        <p class="text-gray-600 dark:text-gray-400">Başvurular 24 saat içinde değerlendirilir ve size bildirilir.</p>
                    </div>
                    <div class="text-center p-6">
                        ...
                        <h3 class="font-bold text-lg text-gray-900 dark:text-white mb-2">Yüksek Potansiyel</h3>
                        <p class="text-gray-600 dark:text-gray-400">Aylık binlerce iş talebi arasından size uygun olanları seçin.</p>
                    </div>
                    <div class="text-center p-6">
                        ...
                        <p class="text-gray-600 dark:text-gray-400">Teknik destek ekibimiz her zaman yanınızda.</p>
                    </div>
                </div>
            </div>
        </section>
